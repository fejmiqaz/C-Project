...
namespace ASP.NET_Core_6._0_API.Entities
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<Perberesi> Perberesis { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-8EOIU82;Database=RecetaGatimi;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Perberesi>(entity =>
            {
                ...
                entity.HasOne(d => d.Receta)
                    .WithMany(p => p.Perberesit)
                    .HasForeignKey(d => d.RecetaId)
                    .HasConstraintName("FK_Perberesi_Receta");
            });
